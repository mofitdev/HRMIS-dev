<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ptab2t5.aspx.cs" Inherits="HRWebApp.pg.profileforms.ptab2t5" %>
<div class="row" style="padding-top:10px;">
        ...
        <div class="well well-sm">
            <fieldset>
				...
				<div class="row" style="margin-bottom: 5px;">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivOrg"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivBranch"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivDomainname"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivMove"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivPostype"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivPos"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivRank"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivSigndate"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivTushaaldate"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-4 text-right">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivTushaalno"></strong>
                    </div>
                </div>
				<div class="row" style="margin-bottom: 10px;">
                    ...
                    <div class="col-md-8">
                        <strong id="ptab2t5Section1DivDescription"></strong>
                    </div>
                </div>
            </fieldset>
        </div>
    ...
    <div class="col-sm-7">
        <div class="well well-sm">
            <form id="ptab2t5Section1Form" method="post">
                <fieldset>
                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <button id="ptab2t5Section1ButtonSave" runat="server" type="submit" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Хадгалах</button>
                        </div>
                    </div>
                </div>
            </form>
...
<script type="text/javascript">
                    ...
                    globalAjaxVar = $.ajax({
                        ...
                        success: function (msg) {
                            ...
                            globalAjaxVar = $.ajax({
                                ...
                                dataType: "json",
                                success: function (msg) {
                                    $('#ptab2t5Section1DivOrg').html(msg.d.split('~')[0]);
                                    $('#ptab2t5Section1DivBranch').html(msg.d.split('~')[1]);
                                    $('#ptab2t5Section1DivDomainname').html(msg.d.split('~')[2]);
                                    $('#ptab2t5Section1DivMove').html(msg.d.split('~')[3]);
                                    $('#ptab2t5Section1DivPostype').html(msg.d.split('~')[4]);
                                    $('#ptab2t5Section1DivPos').html(msg.d.split('~')[5]);
                                    $('#ptab2t5Section1DivRank').html(msg.d.split('~')[6]);
                                    $('#ptab2t5Section1DivSigndate').html(msg.d.split('~')[7]);
                                    $('#ptab2t5Section1DivTushaaldate').html(msg.d.split('~')[8]);
                                    $('#ptab2t5Section1DivTushaalno').html(msg.d.split('~')[9]);
                                    $('#ptab2t5Section1DivDescription').html(msg.d.split('~')[10]);
                                },
    ...
    $('#ptab2t5Section1Form').bootstrapValidator({
        fields: {
            pTab1ModalSelectOrg: {
                group: '.col-md-3',
                validators: {
                                ...
                                globalAjaxVar = $.ajax({
                                    ...
                                    success: function (msg) {
                                        ...
                                        globalAjaxVar = $.ajax({
                                            ...
                                            dataType: "json",
                                            success: function () {
                                                smallBox('Ажилтаныг албанаас халах', 'Амжилттай хадгалагдлаа', '#659265', 4000);
                                            },
                                            failure: function (response) {
                                                alert('FAILURE: ' + response.d);
                                            },
